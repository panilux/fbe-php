...
use FBE\Exceptions\BufferUnderflowException;
...
final class WriteBuffer extends Buffer
{
     ...
     *
     * @param int $offset Offset to write at
     * @param \FBE\Types\Uuid $uuid UUID to write
     */
    public function writeUuid(int $offset, \FBE\Types\Uuid $uuid): void
    {
     ...
     *
     * @param int $offset Offset to write at
     * @param \FBE\Types\Decimal $decimal Decimal to write
     */
    public function writeDecimal(int $offset, \FBE\Types\Decimal $decimal): void
    {
