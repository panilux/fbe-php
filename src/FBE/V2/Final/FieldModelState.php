...
use FBE\V2\Common\{FieldModelFlags, ReadBuffer, WriteBuffer};

/**
 * State flags field model (Final format)
 *
 * Binary: 1 byte (underlying type: byte)
 * Example: State::INITIALIZED | State::CALCULATED = 0x03
 *
 * Note: Identical to Standard format (fixed-size, always inline)
 */
