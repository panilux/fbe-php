...
use FBE\V2\Standard\{FieldModelOptionalInt32 as StdOptionalInt32, FieldModelOptionalString as StdOptionalString};
use FBE\V2\Final\{FieldModelOptionalInt32 as FinalOptionalInt32, FieldModelOptionalString as FinalOptionalString};
